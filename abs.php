    ...
    <div class="container cont">
        ...
        <?php while($row = mysqli_fetch_array($result)) { ?>
            ...
            <?php $bid= $row['bid'];?>
                ...
                <td><?php echo ucwords($hcity); if(ucwords($hcity) == $city){echo '<b style="color:red;margin-left:4px !important;"><a href="https://www.google.com/maps/place/'.$city.'">Near You</a></b>';};?></td>
